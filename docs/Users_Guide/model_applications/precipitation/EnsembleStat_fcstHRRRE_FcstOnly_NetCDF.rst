.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_model_applications_precipitation_EnsembleStat_fcstHRRRE_FcstOnly_NetCDF.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_model_applications_precipitation_EnsembleStat_fcstHRRRE_FcstOnly_NetCDF.py:
...
.. _sphx_glr_download_Users_Guide_model_applications_precipitation_EnsembleStat_fcstHRRRE_FcstOnly_NetCDF.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: EnsembleStat_fcstHRRRE_FcstOnly_NetCDF.py <EnsembleStat_fcstHRRRE_FcstOnly_NetCDF.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: EnsembleStat_fcstHRRRE_FcstOnly_NetCDF.ipynb <EnsembleStat_fcstHRRRE_FcstOnly_NetCDF.ipynb>`
