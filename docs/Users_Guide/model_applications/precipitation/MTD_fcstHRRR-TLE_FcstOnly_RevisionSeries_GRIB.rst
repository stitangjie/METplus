.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_model_applications_precipitation_MTD_fcstHRRR-TLE_FcstOnly_RevisionSeries_GRIB.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_model_applications_precipitation_MTD_fcstHRRR-TLE_FcstOnly_RevisionSeries_GRIB.py:
...
.. _sphx_glr_download_Users_Guide_model_applications_precipitation_MTD_fcstHRRR-TLE_FcstOnly_RevisionSeries_GRIB.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: MTD_fcstHRRR-TLE_FcstOnly_RevisionSeries_GRIB.py <MTD_fcstHRRR-TLE_FcstOnly_RevisionSeries_GRIB.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: MTD_fcstHRRR-TLE_FcstOnly_RevisionSeries_GRIB.ipynb <MTD_fcstHRRR-TLE_FcstOnly_RevisionSeries_GRIB.ipynb>`
