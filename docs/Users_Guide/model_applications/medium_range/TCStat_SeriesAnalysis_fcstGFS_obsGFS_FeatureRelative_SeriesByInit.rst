.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_model_applications_medium_range_TCStat_SeriesAnalysis_fcstGFS_obsGFS_FeatureRelative_SeriesByInit.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_model_applications_medium_range_TCStat_SeriesAnalysis_fcstGFS_obsGFS_FeatureRelative_SeriesByInit.py:
...
.. _sphx_glr_download_Users_Guide_model_applications_medium_range_TCStat_SeriesAnalysis_fcstGFS_obsGFS_FeatureRelative_SeriesByInit.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: TCStat_SeriesAnalysis_fcstGFS_obsGFS_FeatureRelative_SeriesByInit.py <TCStat_SeriesAnalysis_fcstGFS_obsGFS_FeatureRelative_SeriesByInit.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: TCStat_SeriesAnalysis_fcstGFS_obsGFS_FeatureRelative_SeriesByInit.ipynb <TCStat_SeriesAnalysis_fcstGFS_obsGFS_FeatureRelative_SeriesByInit.ipynb>`
