.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_PointStat_PointStat.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_PointStat_PointStat.py:
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_PointStat_PointStat.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: PointStat.py <PointStat.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: PointStat.ipynb <PointStat.ipynb>`
