.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_EnsembleStat_EnsembleStat_python_embedding.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_EnsembleStat_EnsembleStat_python_embedding.py:
...
.. note:: `EnsembleStatToolUseCase <https://ncar.github.io/METplus/search.html?q=EnsembleStatToolUseCase&check_keywords=yes&area=default>`_, `PythonEmbeddingFileUseCase <https://ncar.github.io/METplus/search.html?q=PythonEmbeddingFileUseCase&check_keywords=yes&area=default>`_, `EnsembleAppUseCase <https://ncar.github.io/METplus/search.html?q=EnsembleAppUseCase&check_keywords=yes&area=default>`_, `ProbabilityGenerationAppUseCase <https://ncar.github.io/METplus/search.html?q=ProbabilityGenerationAppUseCase&check_keywords=yes&area=default>`_
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_EnsembleStat_EnsembleStat_python_embedding.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: EnsembleStat_python_embedding.py <EnsembleStat_python_embedding.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: EnsembleStat_python_embedding.ipynb <EnsembleStat_python_embedding.ipynb>`
