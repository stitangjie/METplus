.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_python_embedding.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_python_embedding.py:
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_python_embedding.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: PCPCombine_python_embedding.py <PCPCombine_python_embedding.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: PCPCombine_python_embedding.ipynb <PCPCombine_python_embedding.ipynb>`
