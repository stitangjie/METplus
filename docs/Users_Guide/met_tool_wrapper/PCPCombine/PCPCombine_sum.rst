.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_sum.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_sum.py:
...
with the -c option, i.e. -c parm/use_cases/met_tool_wrapper/PCPCombine/PCPCombine_sum.conf

.. highlight:: bash
.. literalinclude:: ../../../../parm/use_cases/met_tool_wrapper/PCPCombine/PCPCombine_sum.conf
...
1) Passing in PCPCombine_sum.conf then a user-specific system configuration file::
       ...
       master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/PCPCombine/PCPCombine_sum.conf -c /path/to/user_system.conf

2) Modifying the configurations in parm/metplus_config, then passing in PCPCombine_sum.conf::

       master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/PCPCombine/PCPCombine_sum.conf
...
Output for this use case will be found in met_tool_wrapper/PCPCombine/PCPCombine_sum (relative to **OUTPUT_BASE**)
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_sum.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: PCPCombine_sum.py <PCPCombine_sum.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: PCPCombine_sum.ipynb <PCPCombine_sum.ipynb>`
