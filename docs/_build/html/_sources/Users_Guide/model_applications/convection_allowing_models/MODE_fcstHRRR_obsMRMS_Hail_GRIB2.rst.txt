.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_model_applications_convection_allowing_models_MODE_fcstHRRR_obsMRMS_Hail_GRIB2.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_model_applications_convection_allowing_models_MODE_fcstHRRR_obsMRMS_Hail_GRIB2.py:
...
.. _sphx_glr_download_Users_Guide_model_applications_convection_allowing_models_MODE_fcstHRRR_obsMRMS_Hail_GRIB2.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: MODE_fcstHRRR_obsMRMS_Hail_GRIB2.py <MODE_fcstHRRR_obsMRMS_Hail_GRIB2.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: MODE_fcstHRRR_obsMRMS_Hail_GRIB2.ipynb <MODE_fcstHRRR_obsMRMS_Hail_GRIB2.ipynb>`
