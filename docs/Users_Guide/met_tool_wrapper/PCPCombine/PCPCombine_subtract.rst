.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_subtract.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_subtract.py:
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_PCPCombine_PCPCombine_subtract.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: PCPCombine_subtract.py <PCPCombine_subtract.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: PCPCombine_subtract.ipynb <PCPCombine_subtract.ipynb>`
