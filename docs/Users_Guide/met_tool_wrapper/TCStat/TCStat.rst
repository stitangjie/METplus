.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_TCStat_TCStat.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_TCStat_TCStat.py:
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_TCStat_TCStat.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: TCStat.py <TCStat.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: TCStat.ipynb <TCStat.ipynb>`
