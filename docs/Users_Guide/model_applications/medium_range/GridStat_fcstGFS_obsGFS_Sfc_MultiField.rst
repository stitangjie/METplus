.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_model_applications_medium_range_GridStat_fcstGFS_obsGFS_Sfc_MultiField.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_model_applications_medium_range_GridStat_fcstGFS_obsGFS_Sfc_MultiField.py:
...
Output for this use case will be found in gather_by_date/stat_analysis/grid2grid/sfc (relative to **OUTPUT_BASE**)
...
.. _sphx_glr_download_Users_Guide_model_applications_medium_range_GridStat_fcstGFS_obsGFS_Sfc_MultiField.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: GridStat_fcstGFS_obsGFS_Sfc_MultiField.py <GridStat_fcstGFS_obsGFS_Sfc_MultiField.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: GridStat_fcstGFS_obsGFS_Sfc_MultiField.ipynb <GridStat_fcstGFS_obsGFS_Sfc_MultiField.ipynb>`
