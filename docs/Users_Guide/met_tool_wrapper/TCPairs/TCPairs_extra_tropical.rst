.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_TCPairs_TCPairs_extra_tropical.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_TCPairs_TCPairs_extra_tropical.py:
...
generated by running the GFDL cyclone tracker in Extra Tropical Cyclone 
mode on global model output.
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_TCPairs_TCPairs_extra_tropical.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: TCPairs_extra_tropical.py <TCPairs_extra_tropical.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: TCPairs_extra_tropical.ipynb <TCPairs_extra_tropical.ipynb>`
