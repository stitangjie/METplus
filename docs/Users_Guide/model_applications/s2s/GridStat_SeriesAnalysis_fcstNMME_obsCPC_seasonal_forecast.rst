.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_model_applications_s2s_GridStat_SeriesAnalysis_fcstNMME_obsCPC_seasonal_forecast.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_model_applications_s2s_GridStat_SeriesAnalysis_fcstNMME_obsCPC_seasonal_forecast.py:
...
.. _sphx_glr_download_Users_Guide_model_applications_s2s_GridStat_SeriesAnalysis_fcstNMME_obsCPC_seasonal_forecast.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: GridStat_SeriesAnalysis_fcstNMME_obsCPC_seasonal_forecast.py <GridStat_SeriesAnalysis_fcstNMME_obsCPC_seasonal_forecast.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: GridStat_SeriesAnalysis_fcstNMME_obsCPC_seasonal_forecast.ipynb <GridStat_SeriesAnalysis_fcstNMME_obsCPC_seasonal_forecast.ipynb>`
