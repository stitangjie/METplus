.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_template_use-case-application.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_template_use-case-application.py:
...
.. _sphx_glr_download_Users_Guide_template_use-case-application.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: use-case-application.py <use-case-application.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: use-case-application.ipynb <use-case-application.ipynb>`
