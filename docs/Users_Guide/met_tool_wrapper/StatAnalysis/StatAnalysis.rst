.. note::
    ...
    Click :ref:`here <sphx_glr_download_Users_Guide_met_tool_wrapper_StatAnalysis_StatAnalysis.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Users_Guide_met_tool_wrapper_StatAnalysis_StatAnalysis.py:
...
.. _sphx_glr_download_Users_Guide_met_tool_wrapper_StatAnalysis_StatAnalysis.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: StatAnalysis.py <StatAnalysis.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: StatAnalysis.ipynb <StatAnalysis.ipynb>`
